...
import {fetchBookSearchResults, fetchBorrowedBooks} from "@/config/API/book/bookService";
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                const data = await fetchBorrowedBooks(user.id);
            ...
            {borrowedBooks? (
                <>
                    <div
                        ...
                        <p>
                            You have: {borrowedBooks.length} borrowed books
                        </p>
                    </div>
